...
<template>
  <button class="bot__icon" type="button" aria-label="Chat öffnen" @click="openBot">
    <LogoBotIcon />
  </button>
  <component-bot-content :is-open-dialog="isOpenDialog" @close-dialog="messagesStore.setIsOpenDialog(false)" />
</template>
