...
const props = defineProps<{
  projects_blocks: IProjectsBlocks[]
}>()
</script>
...
<template>
  <section class="projects-blocks baseBorderBottom">
    <div v-for="(project, index) in props.projects_blocks" :key="index" class="projects-blocks__block">
      ...
      <div class="projects-blocks__panels">
        <div class="projects-blocks__panel projects-blocks__panel--before">
        ...
        <div class="projects-blocks__panel projects-blocks__panel--after">
