...
<template>
  <div class="message-bot__container">
    <div class="message-bot__logo">
      <LogoBotIcon/>
    </div>
    <div v-if="!props.text?.includes('https://') || (props.text?.includes('https://') && !isLastMessage)" class="message-bot__bubble">
      {{ props.text }}
    </div>
    <div v-if="props.text?.includes('https://') && isLastMessage" class="message-bot__bubble">
