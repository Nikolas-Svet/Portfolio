...
const blocks = [
  {
    link: Consts.Routes.projectsOnlineShop,
  ...
  {
    link: Consts.Routes.projectsPizzeria,
  ...
  {
    link: Consts.Routes.projectsCrmSystem,
...
<template>
  ...
  <div class="projects-blocks">
    ...
    <div class="projects-blocks__cards">
      <template v-for="(block, index) in blocks">
        <NuxtLink
          v-if="!isMobile || (isMobile && currentIndex === index)"
          :key="index"
          class="block"
          :class="{ block__active: currentIndex === 1 && index === 1 && !isMobile }"
          :to="block.link"
          @mouseleave="!isMobile ? currentIndex = 1 : null"
